/* uKernel hamis <linux/msdos_fs.h> — FAT on-disk struktúrák + makrók.
 * A valódi uapi/linux/msdos_fs.h tartalmát emeli át (önálló, csak típusok). */
#ifndef _UK_LINUX_MSDOS_FS_H
#define _UK_LINUX_MSDOS_FS_H

#include <linux/types.h>
#include <linux/uidgid.h>    /* kuid_t/kgid_t — a fat_mount_options használja */
