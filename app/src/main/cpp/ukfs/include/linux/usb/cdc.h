/* uKernel hamis <linux/usb/cdc.h> — a teljes CDC descriptor- és
 * konstans-keszlet (UAPI tartalom + parsed_header). Tiszta adat-strukturak,
 * a kernel UAPI fejlecet tukrozve (nem kernelforras-modositas). */
#ifndef _UK_LINUX_USB_CDC_H
#define _UK_LINUX_USB_CDC_H
